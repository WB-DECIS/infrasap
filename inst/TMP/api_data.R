...
expect_equal(unique(dat$`Indicator Sector`), c("Energy", "Digital Development", "National", "Transport", "Cross-cutting", 
                                               "Transport Railways", "Transport Port", "Transport Road"))
